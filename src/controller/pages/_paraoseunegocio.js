export const paraOSeuNegocio = {
    title : 'para o seu negócio',
    metaTitle: 'IRB Automotive - Para o seu negócio',
    metaDescription: [' Blablabla',' blablabla 2'],
    imgDescription :{
      title: 'Lorem Ipsum is simply dummy',
      image : '/images/pages/autoparts/imgdescription.svg',
      imageSobre: '/images/pages/autoparts/mecanico.svg',
      description: [
