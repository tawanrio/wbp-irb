...
export default function Error({ content }) {
  return (
    <section
      id="error"
      className="mx-auto flex w-full max-w-7xl flex-col items-center justify-center gap-6 px-5 py-52"
    >
      <svg
        ...
        dataReactid="8"
      >
        <g fill="none" fillRule="evenodd" dataReactid="9">
          <path
            fill="#CCC"
      ...
      <div className="flex flex-col gap-3 text-center">
        ...
        <Link href="/" className="mx-auto w-fit text-sm hover:underline">
          {content.linkText}
        </Link>
      </div>
    </section>
