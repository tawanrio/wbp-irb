  ...
  return (
    <>
      ...
      <div
        ...
        className="absolute right-0 top-0 !z-[999] mt-16 flex w-[65%] flex-col p-4 pt-0 capitalize opacity-0 duration-500 md:relative md:z-50 md:mt-0 md:w-full md:flex-row md:items-center md:justify-end md:gap-0 md:p-0 md:opacity-100"
      >
