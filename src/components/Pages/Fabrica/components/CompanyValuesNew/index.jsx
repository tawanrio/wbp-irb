      ...
      <ul className="flex w-full flex-col justify-center gap-8 lg:flex-row">
        {COMPANY_CORE_VALUES.map((card, index) => (
          <li
            ...
            className={cn(
              'group relative flex min-w-[240px] flex-initial cursor-pointer flex-col overflow-hidden rounded-[21.58px] border border-solid border-[#FFFFFF4D] bg-[#D9D9D91A] pb-6 pt-4 transition-all duration-500 ease-in-out md:w-full md:min-w-[250px] md:pb-10',
              expandedCard === index
                ? '!max-h-[500px]'
