export default function Arrow({controllerBanner}) {
  ...
  return (
    ...
    className={`
      ...
      <svg className="md:w-24  w-8 select-none" xmlns="https://www.w3.org/2000/svg" width="45" height="45" viewBox="0 0 24 24" fill="none" stroke="currentColor"  ><path d="m15 18-6-6 6-6"/></svg>
      </a>
      <a 
      ...
      " role="button" href="#" onClick={nextBanner}>
        <svg className="md:w-24 w-8  select-none" xmlns="https://www.w3.org/2000/svg" width="45" height="45" viewBox="0 0 24 24" fill="none" stroke="currentColor"  ><path d="m9 18 6-6-6-6"/></svg>
      </a>
        </div>
  )
}