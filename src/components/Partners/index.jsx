        ...
        <div className="my-10 flex flex-wrap justify-center gap-5 md:my-2 md:gap-8">
          {partners?.map((partner, pId) => (
            <Link
              key={pId}
              href={'/' + partner.label}
              className="group relative flex h-40 min-w-[40%] flex-1 items-center justify-center overflow-hidden rounded-3xl grayscale-[80%] duration-500 before:absolute before:z-[2] before:block before:h-full before:w-full before:bg-[#0a0a0ab4] before:content-[''] hover:scale-105 md:min-w-[20%]"
            >
              <div>
                <Image
                  fill
