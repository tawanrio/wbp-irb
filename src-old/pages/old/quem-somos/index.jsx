...
export default function QuemSomos({page, partners, products, form, menu, template}) {
  ...
  return (
    ...
    <Templates template={template} page={page}>
        ...
        <Partners title={partners?.title} partners={partners?.types}  colors={partners?.colors}/>
        <Products products={products} colors={page?.colors.products} title={'Produtos'} />
...
async function getDataPage(){
  ...
  const page = await Page.findOne({label:"about"}).lean();
